...
* ***GitHub*** [True visibility - Checks if a DOM element is truly visible](https://github.com/UseAllFive/true-visibility)
...
* ***MozDev*** [Page Visibility API](https://developer.mozilla.org/en-US/docs/Web/API/Page_Visibility_API)
